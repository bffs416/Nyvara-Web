...
const services = [
    {
      ...
      description: "Atraemos, convertimos y fidelizamos a tu cliente ideal con estrategias de datos. Creamos audiencias, no solo seguidores.",
    ...
    },
    {
      ...
      description: "Convertimos eventos en herramientas de negocio. Diseñamos experiencias memorables que fortalecen tu marca y crean conexiones.",
    ...
    },
    {
      ...
      description: "Creamos el motor tecnológico que tu negocio necesita para escalar, con aplicaciones y software a la medida.",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <motion.div
                ...
                className="h-full"
              >
                <Card className="bg-neutral-50 border-border/50 hover:border-primary/50 transition-all duration-300 h-full flex flex-col hover:shadow-[0_0_20px_4px_hsl(var(--secondary)/0.5)] hover:scale-105">
