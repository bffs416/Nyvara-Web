...
const projectSchema = z.object({
  ...
  kpis: z.object({
    contentType: z.enum(['reel', 'historia', 'carrusel', 'video', 'post', 'pdf', 'carnet', 'otro']),
    ...
    plays: z.number().nonnegative().optional(),
    likes: z.number().nonnegative().optional(),
    reposts: z.number().nonnegative().optional(),
    profileVisits: z.number().nonnegative().optional(),
    linkClicks: z.number().nonnegative().optional(),
    shares: z.number().nonnegative().optional(),
    comments: z.number().nonnegative().optional(),
    saves: z.number().nonnegative().optional(),
    newFollowers: z.number().nonnegative().optional(),
    followerViewsPercent: z.number().min(0).max(100).optional(),
    nonFollowerViewsPercent: z.number().min(0).max(100).optional(),
    followerInteractionsPercent: z.number().min(0).max(100).optional(),
    nonFollowerInteractionsPercent: z.number().min(0).max(100).optional(),
    avgWatchTimeSec: z.number().nonnegative().optional(),
    videoDurationSec: z.number().nonnegative().optional(),
    skipRatePercent: z.number().min(0).max(100).optional(),
    usualSkipRatePercent: z.number().min(0).max(100).optional(),
    feedViewsPercent: z.number().min(0).max(100).optional(),
    reelsTabViewsPercent: z.number().min(0).max(100).optional(),
    profileViewsPercent: z.number().min(0).max(100).optional(),
    storiesViewsPercent: z.number().min(0).max(100).optional(),
    searchViewsPercent: z.number().min(0).max(100).optional(),
    exploreViewsPercent: z.number().min(0).max(100).optional(),
    womenAudiencePercent: z.number().min(0).max(100).optional(),
    menAudiencePercent: z.number().min(0).max(100).optional(),
    storyNavigation: z.number().nonnegative().optional(),
    storyBacks: z.number().nonnegative().optional(),
    storyForwards: z.number().nonnegative().optional(),
    storyNextStory: z.number().nonnegative().optional(),
    storyExits: z.number().nonnegative().optional(),
    storyReplies: z.number().nonnegative().optional(),
